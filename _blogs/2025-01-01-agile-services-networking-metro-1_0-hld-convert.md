...
![]({{site.url}}/design/images/asn-metro/metro-srv6-igp-domains.png){:height="100%" width="100%"}
...
![]({{site.url}}/design/images/asn-metro/asn-rpon-pluggable.png){:height="75%" width="75%"}
...
![]({{site.url}}/design/images/asn-metro/asn-rpon-manager.png)
...
![]({{site.url}}/design/images/asn-metro/cnc-71-fleet-upgrade-1.png)
...
![]({{site.url}}/design/images/asn-metro/asn-dpm-create-policy.png)

Once a policy is enabled on a device, it can then be monitored by looking at 
the inventory of the device.   

![]({{site.url}}/design/images/asn-metro/asn-dpm-gnss-satellite.png)
...
![]({{site.url}}/design/images/asn-metro/cnc71-srv6-te-path.png)

CNC can also visualize the end to end IGP path taken by each segment, showing 
ECMP traffic paths.  

![]({{site.url}}/design/images/asn-metro/cnc71-sdwan-te-path-igp.png)
...
![]({{site.url}}/design/images/asn-metro/cnc71-flex-algo.png)
...
![]({{site.url}}/design/images/asn-metro/ron4-cicuit-creation-57b1-3d-view.png)
...
![]({{site.url}}/design/images/asn-metro/ron4-link-assurance-57b1-5.png)
